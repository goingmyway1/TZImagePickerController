...
// Apply selection UI state (updates select image / index label / optional animation).
- (void)applySelectionState:(BOOL)selected animated:(BOOL)animated;
// Expose big image request control for caller to prefetch/cancel when selection changes.
